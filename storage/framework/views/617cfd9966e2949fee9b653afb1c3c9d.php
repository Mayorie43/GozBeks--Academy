...
<head>
    ...
    <link rel="shortcut icon" href="images/img16.jpg" type="image/x-icon">
    <!-- GOOGLE FONT -->
        ...
        <div class="ed-mob-menu">
            <div class="ed-mob-menu-con">
                <div class="ed-mm-left">
                    <div class="wed-logo">
                    <a href="#"><img src="images/logo5.jpg" alt="" style="height: 55px; width: auto;" /></a>
						</a>
                    </div>
                </div>
                    ...
                    <div class="ed-mm-menu">
                        ...
                        <div class="ed-mm-inn">
                            ...
                            <li><a href="index-2.html">Home</a></li>
                                ...
                                <!-- <li><a href="course-details.html">Gallery</a></li> -->
                            ...
                            <h4>All Subjects</h4>
                            <ul>
                                <li><a href="course-details.html">Financial Accounting</a></li>
                                <li><a href="course-details.html">English Language</a></li>
                                <li><a href="course-details.html">Mathematics</a></li>
                                <li><a href="course-details.html">Social Studies</a></li>
                                <li><a href="course-details.html">Home Economics</a></li>
                                <li><a href="course-details.html">Hand Writing</a></li>
                                <li><a href="course-details.html">Physical Education</a></li>
                                <li><a href="course-details.html">Political Science</a></li>
                                <li><a href="course-details.html">Business Studies</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ed-com-t1-left">
                            <ul>
                                <li><a href="#">Address: Salome Igbonogba Street Amachai Behind 2nd Sunny Estate Okpanam, Oshimili North L.G.A,Delta State</a>
                                </li>
                                <li><a href="#">Phone: 08030918374 / 08035475924</a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="top-logo" data-spy="affix" data-offset-top="250">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="wed-logo">
                        <a href="#"><img src="images/logo5.jpg" alt="" style="height: 85px; width: auto;" /></a>
                            </a>
                        </div>
                        ...
                        <div class="main-menu">
                            <ul>
                                        ...
                                        <div class="about-mm m-menu">
                                            <div class="m-menu-inn">
                                                ...
                                                <div class="mm1-com mm1-s2">
                                                    <p>At Gozbeks School, we believe that education is the cornerstone of personal and societal growth. Our academic program is designed to challenge and inspire students, fostering a deep love for learning and intellectual curiosity.</p>
                                                ...
                                                <div class="mm1-com mm1-s2">
                                                    <p>Our curriculum is thoughtfully crafted to meet the diverse needs and interests of our students. From the foundational years through to advanced studies, we offer a wide range of subjects that encourage exploration and mastery.</p>
                                                    <a href="#" class="mm-r-m-btn">Read more</a>
                                                </div>

                                                <div class="mm1-com mm1-s2">
                                                    <p>At Gozbeks School, we emphasize critical thinking, creativity, and collaboration. We encourage students to ask questions, explore new ideas, and challenge themselves academically. Our goal is to prepare students not just for exams, but for lifelong success, ensuring they are ready to thrive in their future academic and career endeavors.</p>
                                                    <a href="#" class="mm-r-m-btn">Read more</a>
                                                </div>
                                        ...
                                        <div class="admi-mm m-menu">
                                            <div class="m-menu-inn">
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    ...
                                                    <p>At Gozbeks School, we are dedicated to providing a top-notch academic experience that fosters intellectual curiosity, critical thinking, and a lifelong love of learning. </p>
                                                ...
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    ...
                                                    <p>At Gozbeks School, we believe that every student has the potential to excel and grow. Our admissions process is designed to identify and welcome students who will thrive in our dynamic and supportive environment Mauris non tincidunt lectus. Nulla mollis, orci vitae accumsan rhoncus.</p>
                                                ...
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    ...
                                                    <p>Excellence in Arts Awards: Gozbeks School has been honored with several awards for outstanding achievements in arts and humanities, showcasing the creative talents of our students.</p>
                                                ...
                                                <div class="mm2-com mm1-com mm1-s4">
                                                    ...
                                                    <p>At Gozbeks School, we are excited to announce our upcoming Seminar for 2024, a hallmark event in our academic calendar designed to inspire, educate, and engage our students and the wider community. </p>
                                ...
                                <li><a href="events.html">News</a>
                                </li>
                                <!-- <li><a href="dashboard.html">Gallery</a>
                                </li> -->
            ...
            <div class="carousel-inner">
                <div class="item slider1 active">
                    ...
                    <div class="carousel-caption slider-con">
                        <h2>Welcome to <span> GozBeks School</span></h2>
                        <p>Gozbeks School is committed to providing a nurturing environment where students are encouraged to reach their full potential. Our dedicated staff and innovative programs ensure that each student receives a well-rounded education, preparing them for a successful future.</p>
                        <a href="#" class="bann-btn-1">APPLY FOR ADMISSION</a>
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption slider-con">
                        <h2>Admission open <span>2024</span></h2>
                ...
                <div class="item">
                    ...
                    <div class="carousel-caption slider-con">
                        <h2>GOZBEKS <span>SCHOOL</span></h2>
                        <p>Thanks so much for visiting, we are delighted that you are interested in our schools and also at enrolling your child.</p>
                        <a href="#" class="bann-btn-1">APPLY FOR ADMISSION</a>
                        <!-- <a href="#" class="bann-btn-2">Read More</a> -->
                    </div>
                </div>
        ...
        <div class="container com-sp pad-bot-70">
            <div class="row">
                <div class="con-title">
                    ...
                    <p> <strong>Our Vision:</strong> At Gozbeks School, our vision is to foster a love for learning in every student, guiding them to become critical thinkers, creative problem solvers, and responsible global citizens.</p>
                </div>  
            </div>
        ...
        <div class="col-md-8">
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <p class="card-text">At Gozbeks School, our vision is to foster a love for learning in every student, guiding them to become critical thinkers, creative problem solvers, and responsible global citizens.</p>
                </div>
            </div>
            <div class="card mb-4">
                <div class="card-body text-center">
                    <h4 class="card-title">Our Mission</h4>
                    <p class="card-text">We strive to provide a comprehensive education that nurtures intellectual curiosity, social responsibility, and emotional well-being. Our mission is to empower students to achieve academic excellence and develop the skills needed to navigate a complex and dynamic world.</p>
                </div>
            </div>
            <div class="card mb-4">
                <div class="card-body text-center">
                    <h4 class="card-title">Our History</h4>
                    <p class="card-text">Founded in [Year], Gozbeks School has grown from a small community institution into a leading educational establishment known for its commitment to academic excellence and student development. Over the years, we have built a reputation for providing a safe and supportive environment where students can thrive.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container com-sp">
            <div class="row">
                <div class="con-title">
                    ...
                    <span class="text-muted fw-semibold">Stay informed with the latest news and events at Gozbeks School! Our vibrant school community is always buzzing with exciting activities, achievements, and opportunities for students, parents, and staff. From academic accomplishments and sports victories to cultural festivals and special guest speakers, there’s always something happ
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="bot-gal h-vid ho-event-mob-bot-sp">
                        ...
                        <h5>Welcome to the Gozbeks School Video Gallery</h5>
                        <p>where moments come to life! Our collection of videos showcases the dynamic environment and diverse experiences that define our school community</p>
                        <p>Explore our video gallery to see students in action, witness their achievements, and feel the spirit of our school. </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="bot-gal h-blog ho-event">
                        ...
                        <div class="ho-event">
                            <ul>
                                <li>
                                    <div class="ho-ev-date"><span>09</span><span>nov,2024</span>
                                    </div>
                                    <div class="ho-ev-link">
                                        <a href="#">
                                            <h4>Cultural Day Celebration</h4>
                                        </a>
                                        <p>Gozbeks School Grounds</p>
                                        <span> 9:00 AM – 3:00 pm</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="ho-ev-date"><span>4</span><span>dec,2024</span>
                                    </div>
                                    <div class="ho-ev-link">
                                        <a href="#">
                                            <h4>Annual Sports Day</h4>
                                        </a>
                                        <p> Gozbeks School Sports Field.</p>
                                        <span> 8:00 AM – 1:00 pm</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="ho-ev-date"><span>19</span><span>dec,2024</span>
                                    </div>
                                    <div class="ho-ev-link">
                                        <a href="events.html">
                                            <h4>Winter Concert</h4>
                                        </a>
                                        <p>Gozbeks School Auditorium.</p>
                                        <span>2:00 PM – 5:00 PM</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="ho-ev-date"><span>14</span><span>jan,2025</span>
                                    </div>
                                    <div class="ho-ev-link">
                                        <a href="events.html">
                                            <h4>Parent-Teacher Conference</h4>
                                        </a>
                                        <p>Gozbeks School Classrooms</p>
                                        <span>9:15 am – 2:00 pm</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="bot-book">
                        ...
                        <div class="col-md-7 bb-text">
                            ...
                            <p> At Gozbeks School, we value authenticity and creativity. We believe in delivering content that is not only free from repetition but also truly reflective of unique perspectives and ideas.</p>
                        </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text fw-bold text-muted">
                        <a href="mailto:info@gozbeks-school.com">info@gozbeks-school.com</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 text-center mb-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text fw-bold text-muted">
    Salome Igbonogba Street Amachai Behind 2nd Sunny Estate Okpanam,<br>
    Oshimili North L.G.A, Delta State
</p>
        ...
        <div class="col-md-4 text-center mb-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <a href="tel:+1234567890">08030918374 / 08035475924</a>
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row wed-foot-link">
                <div class="col-md-4 foot-tc-mar-t-o">
                    ...
                    <ul>
                        ...
                        <li><a href="course-details.html">English Language</a></li>
                        <li><a href="course-details.html">Social Studies</a></li>
                        <li><a href="course-details.html">Agricultural Science</a></li>
                        <li><a href="course-details.html">Biology</a></li>
                        <li><a href="course-details.html">Economics</a></li>
                        <li><a href="course-details.html">Physical Science</a></li>
                        <li><a href="course-details.html">Basic Science</a></li>
                    </ul>
                </div>
                <!-- <div class="col-md-4">
                    <h4>New Courses</h4>
            ...
            <div class="row wed-foot-link-1">
                <div class="col-md-4 foot-tc-mar-t-o">
                    <h4>Get In Touch</h4>
                    <p>Address: Contact: Salome Igbonogba Street Amachai Behind 2nd Sunny Estate Okpanam, Oshimili North L.G.A,Delta State</p>
                    <p>Phone: <a href="#!">+234 8030918374 / 08035475924 </a></p>
                    <p>Email: <a href="#!">GozBeks School@gmail.com</a></p>
                </div>
                <div class="col-md-4">
        ...
        <div class="container">
            <div class="row">
                <div class="copy-right">
                   <a target="_blank" href="#">Copyright © 2024 GozBeks School, Okpanam. All rights reserved </a>
                </div>
            </div>
        </div>
    </section>
...
</html><?php /**PATH C:\Users\830 G5\Desktop\Project\projects\resources\views/home.blade.php ENDPATH**/ ?>